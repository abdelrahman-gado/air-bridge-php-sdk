...
final class CommonTest extends TestCase
{
    ...
    #[Test()]
    public function testConfigReturnNullWhenNoMatch(): void
    {
        $this->assertNull(Common::config('nonExistentKey'));
        $this->assertNull(Common::config('trackingLinks.nonExistentKey'));
    }
}
